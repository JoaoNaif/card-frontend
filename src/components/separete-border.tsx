export function SeparateBorder() {
  return (
    <div className="relative w-full h-px mt-7 bg-border-default">
      <div className="absolute top-1/2 left-1/2 rotate-45 transform -translate-x-1/2 -translate-y-1/2 w-4 h-4 border border-[#FBBC05] flex items-center justify-center">
